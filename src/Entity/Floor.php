...
class Floor
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Area", mappedBy="floor", orphanRemoval=true)
     */
    private $areas;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Room", mappedBy="floor", orphanRemoval=true)
     */
    private $rooms;
